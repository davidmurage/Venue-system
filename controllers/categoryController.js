...
export const categoryController = async (req, res) => {
    try{
        ...
        console.log(error);
        res.status(500).send({success: false, message: 'Error in getting categories'});
    }
};
...
export const singleCategoryController = async (req, res) => {
    try{
        ...
        res.status(200).send({success: true, message: 'Getting Single category successful', category});
    }catch(error){
        console.log(error);
        res.status(500).send({success: false, message: 'Error in getting single category'});
    }
};
...
export const deleteCategoryController = async (req, res) => {
    try{
        ...
        console.log(error);
        res.status(500).send({success: false, message: 'Error in deleting category'});
    }
};
